...
import com.sport.sportapp.databinding.AthleteBySportLayoutBinding;
...
public class AthletesBySportAdapter extends RecyclerView.Adapter<AthletesBySportAdapter.AthleteViewHolder> {

    private final List<AthleteIdNameSportModel> athletes;
    private final MainActivityViewModel viewModel;

    public AthletesBySportAdapter(List<AthleteIdNameSportModel> athletes, MainActivityViewModel viewModel) {
    ...
    public AthleteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AthleteViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.athlete_by_sport_layout,parent,false),
                viewModel
        );
    }
    ...
    public static class AthleteViewHolder extends RecyclerView.ViewHolder{
        ...
        private final AthleteBySportLayoutBinding binding;
        private final MainActivityViewModel viewModel;

        public AthleteViewHolder(@NonNull View itemView, MainActivityViewModel viewModel) {
            super(itemView);
            this.viewModel = viewModel;
            binding = AthleteBySportLayoutBinding.bind(itemView);
        ...
        private void bindData(AthleteIdNameSportModel athlete) {
            binding.athleteSportInput.setText(String.valueOf(athlete.getSportId()));
